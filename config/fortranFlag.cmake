...
if ("${CMAKE_Fortran_COMPILER_ID}" MATCHES "Intel")
    ...
    if (WIN32)
        ...
        set(Fortran_FLAG_GLOBAL_RELEASE "-fpp -ipo -fPIC -O2 -xHOST -ip -mkl:sequential -openmp -heap-arrays" )
        set(Fortran_FLAG_GLOBAL_DEBUG   "-fpp -ipo -fPIC -O0 -traceback -mkl:sequential -openmp -heap-arrays" )
    endif()
